...
* build: add dateFormat dependency ([e7b989d](https://github.com/akveo/react-native-ui-kitten/commit/e7b989d))
* build: add moment and date-fns as dev dependencies ([1b8a478](https://github.com/akveo/react-native-ui-kitten/commit/1b8a478))
* build: fix ts build issues ([5ef0a82](https://github.com/akveo/react-native-ui-kitten/commit/5ef0a82))
* build: resolve intellij ts target warning ([d27ed05](https://github.com/akveo/react-native-ui-kitten/commit/d27ed05))
* build(docs): typedoc temporary fix ([14a767b](https://github.com/akveo/react-native-ui-kitten/commit/14a767b))
* build(kitten): package-lock update ([daf8e14](https://github.com/akveo/react-native-ui-kitten/commit/daf8e14))
* build(playground): update app.json ([32dea74](https://github.com/akveo/react-native-ui-kitten/commit/32dea74))
...
* docs(framework): calendar api docs ([c97061a](https://github.com/akveo/react-native-ui-kitten/commit/c97061a))
* docs(guides): add setup @ui-kitten/eva-icons guide ([a092764](https://github.com/akveo/react-native-ui-kitten/commit/a092764))
* docs(guides): add setup 3rd-party icons guide ([f364ea4](https://github.com/akveo/react-native-ui-kitten/commit/f364ea4))
* docs(guides): update setup 3rd-party icons guide ([22569e9](https://github.com/akveo/react-native-ui-kitten/commit/22569e9))
* refactor(playground): component showcase icons ([2ac71cc](https://github.com/akveo/react-native-ui-kitten/commit/2ac71cc))
* refactor(ui): bottom-navigation documentation update ([144abb4](https://github.com/akveo/react-native-ui-kitten/commit/144abb4))
* refactor(ui): calendar - component structure ([64c7fae](https://github.com/akveo/react-native-ui-kitten/commit/64c7fae))
* refactor(ui): calendar - data service ([39308c9](https://github.com/akveo/react-native-ui-kitten/commit/39308c9))
* refactor(ui): calendar - picker views ([46f8bf2](https://github.com/akveo/react-native-ui-kitten/commit/46f8bf2))
* refactor(ui): calendar - proper localization ([21c2a96](https://github.com/akveo/react-native-ui-kitten/commit/21c2a96))
* refactor(ui): calendar - remove month diff function from a date service ([aaca088](https://github.com/akveo/react-native-ui-kitten/commit/aaca088))
* refactor(ui): calendar date-services ([ed8c9f7](https://github.com/akveo/react-native-ui-kitten/commit/ed8c9f7))
* refactor(ui): drawer - container as fragment ([d2247ce](https://github.com/akveo/react-native-ui-kitten/commit/d2247ce))
* refactor(ui): drawer - export react element type ([fe92869](https://github.com/akveo/react-native-ui-kitten/commit/fe92869))
* refactor(ui): dropdown code refactor ([a3d0890](https://github.com/akveo/react-native-ui-kitten/commit/a3d0890))
* refactor(ui): dropdown styling refactor ([b6e77e9](https://github.com/akveo/react-native-ui-kitten/commit/b6e77e9))
* refactor(ui): export element types ([2cd3c62](https://github.com/akveo/react-native-ui-kitten/commit/2cd3c62))
* refactor(ui): export react element types ([fced535](https://github.com/akveo/react-native-ui-kitten/commit/fced535))
* refactor(ui): icon - code style ([b630b16](https://github.com/akveo/react-native-ui-kitten/commit/b630b16))
* refactor(ui): spinner - export react element type ([7dded0d](https://github.com/akveo/react-native-ui-kitten/commit/7dded0d))
...
* feat: moment & date-fns date-services ([b7be496](https://github.com/akveo/react-native-ui-kitten/commit/b7be496))
* feat(docs): overview-examples handling add ([5b7cdeb](https://github.com/akveo/react-native-ui-kitten/commit/5b7cdeb))
* feat(eva-icons): add eva-icons module ([a6500c2](https://github.com/akveo/react-native-ui-kitten/commit/a6500c2))
* feat(playground): icons showcase ([6dfc216](https://github.com/akveo/react-native-ui-kitten/commit/6dfc216))
* feat(ui): calendar - base implementation ([5dac76b](https://github.com/akveo/react-native-ui-kitten/commit/5dac76b))
* feat(ui): calendar - disabled state & filter ([f15f263](https://github.com/akveo/react-native-ui-kitten/commit/f15f263))
* feat(ui): calendar - increase paging performance ([d274a28](https://github.com/akveo/react-native-ui-kitten/commit/d274a28))
* feat(ui): calendar - mark holidays ([2a84ca6](https://github.com/akveo/react-native-ui-kitten/commit/2a84ca6))
* feat(ui): calendar - mode-dependent header title ([7e8844b](https://github.com/akveo/react-native-ui-kitten/commit/7e8844b))
* feat(ui): calendar - proper localization ([2b049cc](https://github.com/akveo/react-native-ui-kitten/commit/2b049cc))
* feat(ui): calendar - reduce measuring ([8ac8dee](https://github.com/akveo/react-native-ui-kitten/commit/8ac8dee))
* feat(ui): calendar - scroll to next year ([33e8642](https://github.com/akveo/react-native-ui-kitten/commit/33e8642))
* feat(ui): calendar - use formatting ([78c129d](https://github.com/akveo/react-native-ui-kitten/commit/78c129d))
* feat(ui): drawer component ([f0188c9](https://github.com/akveo/react-native-ui-kitten/commit/f0188c9))
* feat(ui): dropdown auto-placement feature add ([fff6687](https://github.com/akveo/react-native-ui-kitten/commit/fff6687))
* feat(ui): dropdown auto-placement feature integrate ([25af442](https://github.com/akveo/react-native-ui-kitten/commit/25af442))
* feat(ui): dropdown group-items add ([0e541b3](https://github.com/akveo/react-native-ui-kitten/commit/0e541b3))
* feat(ui): dropdown icon prop add ([2efc8f7](https://github.com/akveo/react-native-ui-kitten/commit/2efc8f7))
* feat(ui): dropdown mappings integrate ([c68f332](https://github.com/akveo/react-native-ui-kitten/commit/c68f332))
* feat(ui): dropdown multiselect feature add ([ee927eb](https://github.com/akveo/react-native-ui-kitten/commit/ee927eb))
* feat(ui): dropdown render custom item feature add ([e52c77a](https://github.com/akveo/react-native-ui-kitten/commit/e52c77a))
* feat(ui): icon - animations ([7de76cd](https://github.com/akveo/react-native-ui-kitten/commit/7de76cd))
* feat(ui): part of dropdown component implement ([d55be5c](https://github.com/akveo/react-native-ui-kitten/commit/d55be5c))
* feat(ui): popover - autoplacement ([27eac63](https://github.com/akveo/react-native-ui-kitten/commit/27eac63))
* feat(ui): spinner component ([e189020](https://github.com/akveo/react-native-ui-kitten/commit/e189020))
* test(ui): calendar - data service ([2fbb0fd](https://github.com/akveo/react-native-ui-kitten/commit/2fbb0fd))
* test(ui): calendar - service tests ([cf53c69](https://github.com/akveo/react-native-ui-kitten/commit/cf53c69))
* test(ui): expand calendar tests with cleaning before each test-case ([58efc1f](https://github.com/akveo/react-native-ui-kitten/commit/58efc1f))
